...
export const DEMO_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { op: "acceptActive", sellerIndex: 0, actor: "BUYER" },
      { op: "sellerOffer", sellerIndex: 0, productId: "tomatoes", quantity: 2, unit: "kg", price: 12, reason: "TIME_DISCOUNT" },
      { op: "assertAdvice", sellerIndex: 0, actor: "BUYER", kind: "ACCEPT_ACTIVE", targetsActiveOffer: true },
  ...
  },
  {
    ...
    steps: [
      ...
      { op: "assertAdvice", sellerIndex: 0, actor: "BUYER", kind: "COUNTER", price: 15 },
      { op: "applyBuyerAdvice", sellerIndex: 0 },
  ...
  },
  {
    ...
    steps: [
      ...
      { op: "createPurchase", policy: "PRIMARY_ONLY", sellerIds: ["seller-a"] },
      { op: "buyerOffer", sellerIndex: 0, productId: "tomatoes", quantity: 2, unit: "kg", price: 15 },
      { op: "assertAdvice", sellerIndex: 0, actor: "SELLER", kind: "ACCEPT_ACTIVE", targetsActiveOffer: true },
