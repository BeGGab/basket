...
- **OQ-030:** Split by TZ-BASKET-007. Canonical statements: **SPEC OQ-002A** (package contents / conversion / partial — OPEN; package-as-unit CONFIRMED) and **SPEC OQ-002B** (concrete volume deal = Offer / I-048; standing quantity-range schedule OPEN). Experiment-log OQ-001 / OQ-002 (resolution / alt *policy*) are different questions and stay untouched.
