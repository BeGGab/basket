...
- **OQ-030:** Split by TZ-BASKET-007; refined by TZ-BASKET-008 (conclusion **B**, no new entity). TZ-BASKET-009 obtained **no business-flow observation** — only catalog/spec reconstruction. TZ-BASKET-010 is Stage-1 **source search** (SOURCE-010-CATALOG/EMULATOR/BASKET/TZ025/TREE): pack-contents and quantity-range are **SOURCE ABSENT** in the inspected files; business-flow observation was **not obtained**. CooperativeSeller accept-as-is is not seller evidence. Canonical: **SPEC OQ-002A** OPEN — package-unit deal does not require stored contents (I-049); conversion / partial / distinct bases remain MODEL GAP. **SPEC OQ-002B** — concrete volume deal = Offer (I-048); standing announcement is not an Offer (I-050); schedule-as-object OPEN. No evidence yet justifies a Package or PriceSchedule entity. Further closing OQ-002A/B requires a business-flow observation where a deal cannot complete without the extra fact. Experiment-log OQ-001 / OQ-002 (resolution / alt *policy*) stay untouched.
