...
- **OQ-030:** Split by TZ-BASKET-007; refined by TZ-BASKET-008 (conclusion **B**, no new entity). TZ-BASKET-009 obtained **no business-flow observation** — only catalog/spec reconstruction (PACKAGE-BIZ-009-001/002, VOLUME-BIZ-009-001, Domain OPEN). Canonical: **SPEC OQ-002A** OPEN — package-unit deal does not require stored contents (I-049); conversion / partial / distinct bases remain MODEL GAP. **SPEC OQ-002B** — concrete volume deal = Offer (I-048); standing announcement is not an Offer (I-050); schedule-as-object OPEN; H3 schedule change NOT OBSERVED. No evidence yet justifies a Package or PriceSchedule entity. Further closing OQ-002A/B requires a business-flow observation, not another synthetic model test. Experiment-log OQ-001 / OQ-002 (resolution / alt *policy*) stay untouched.
