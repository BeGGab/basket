...
Последовательность следующих ТЗ (вне этого PR): ТЗ-001 Domain Experiment → ТЗ-002 Actor/Simulation Runtime → ТЗ-003 Human-facing Simulation UI (возможно поверх существующего Customer/Seller UI) → ТЗ-004+ Buyer/Seller AI Assistants.
