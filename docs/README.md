...
- **[`basket/`](./basket/)** — доменная модель корзины (experimental baseline v0.1): `BASKET_DOMAIN_MODEL.md`, инварианты, сценарии поломки, эмулятор, эксперимент, матрица тестов, открытые вопросы.
