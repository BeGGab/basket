...
| `FLOW-011-A-CONFIG` | Stage-1 deal STABLE without seller product-config; INCONCLUSIVE | `scenarios.ts` FLOW-011-A-CONFIG |
| `FLOW-011-A1` | buyer qty 1 accepted; not seller min | `scenarios.ts` FLOW-011-A1 |
| `FLOW-011-A2` | buyer qty 100 accepted; not product max | `scenarios.ts` FLOW-011-A2 |
| `FLOW-011-A3` | buyer 2/5/12 same unit price; range not seller-set | `scenarios.ts` FLOW-011-A3 |
| `FLOW-011-A4` | stored listing/item have no min/max fields | `scenarios.ts` FLOW-011-A4 |
